...
//     version 1.14.2
//     from Assets/Input/ClickControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/ClickControls.inputactions".
/// </summary>
/// <remarks>
...
public partial class @ClickControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Pointer"",
            ""id"": ""e82b4c60-407b-42c1-b473-3c4a6176c508"",
            ""actions"": [
                {
                    ""name"": ""MouseClick"",
                    ""type"": ""Button"",
                    ""id"": ""a1581db8-932b-4d81-9a6a-ffc694d8667c"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""MousePosition"",
                    ""type"": ""Value"",
                    ""id"": ""3dd8ad1c-c31c-4141-b714-6e20b85194ee"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""733abf9c-f618-46e8-95fa-59d1b6e16abd"",
    ...
    ""controlSchemes"": []
        ...
        m_Pointer_MouseClick = m_Pointer.FindAction("MouseClick", throwIfNotFound: true);
        m_Pointer_MousePosition = m_Pointer.FindAction("MousePosition", throwIfNotFound: true);
    }

    ~@ClickControls()
    {
        UnityEngine.Debug.Assert(!m_Pointer.enabled, "This will cause a leak and performance issues, ClickControls.Pointer.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Pointer_MouseClick;
    ...
    public struct PointerActions
    {
        ...
        /// </summary>
        public PointerActions(@ClickControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Pointer/MouseClick".
        /// </summary>
        public InputAction @MouseClick => m_Wrapper.m_Pointer_MouseClick;
        /// <summary>
        /// Provides access to the underlying input action "Pointer/MousePosition".
        /// </summary>
